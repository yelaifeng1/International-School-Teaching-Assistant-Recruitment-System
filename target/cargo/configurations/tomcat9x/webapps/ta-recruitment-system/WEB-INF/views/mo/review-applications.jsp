...
<div class="page-shell">
    ...
    <%
        ...
        System.out.println("JSON_FILE_PATH: " + jsonFilePath);
    ...
    <div class="panel">
        ...
        %>
                    <div class="info-banner error">Data directory not found</div>
        <%
                }
            } catch (Exception e) {
        %>
                <div class="info-banner error">Failed to load applications data: <%= e.getMessage() %></div>
        <%
            }
        %>
    </div>
