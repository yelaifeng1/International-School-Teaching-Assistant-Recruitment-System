    ...
    <div class="card">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <div class="info-value">Module Organizer</div>
            </div>
            <div class="info-item">
        ...
        <p style="color: #999; margin: 20px 0; font-size: 14px;">
            你可以在这里管理 TA 申请、审核候选人和分配角色。
        </p>
        
        <div class="action-buttons">
            <a href="<%= request.getContextPath() %>/mo/applications.jsp" style="text-decoration: none; flex: 1;">
                <button class="btn btn-primary" style="width: 100%;">查看申请</button>
            </a>
